...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-border/40 bg-card/45 backdrop-blur-xs text-card-foreground shadow-sm",
      className
    )}
    {...props}
  />
...
const CardFooter = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-6 md:p-8 pt-0 md:pt-0 border-t border-border/40", className)}
    {...props}
  />
))
